...
// --- Facts stubs (satisfy Conversation interface; not exercised by session tests) ---

func (m *MemoryStore) AddFact(_, _, _ string) error               { return nil }
func (m *MemoryStore) GetFacts(_, _ string) ([]store.Fact, error) { return nil, nil }
func (m *MemoryStore) DeleteFact(_ string) error                  { return nil }
